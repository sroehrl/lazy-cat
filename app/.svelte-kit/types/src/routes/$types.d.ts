...
type LayoutRouteId = RouteId | "/" | "/(protected)/administration" | "/(protected)/administration/calendar" | "/(protected)/administration/hours" | "/(protected)/administration/members" | "/(protected)/administration/plans" | "/(protected)/administration/prices" | "/(protected)/administration/residents" | "/(protected)/member" | "/auth" | "/auth/forgot-password" | "/auth/register" | "/calendar" | "/checkout" | "/coffee" | "/docs" | "/plans" | null
