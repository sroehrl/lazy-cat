...
type LayoutRouteId = RouteId | "/(protected)/administration" | "/(protected)/administration/calendar" | "/(protected)/administration/hours" | "/(protected)/administration/members" | "/(protected)/administration/plans" | "/(protected)/administration/prices"
