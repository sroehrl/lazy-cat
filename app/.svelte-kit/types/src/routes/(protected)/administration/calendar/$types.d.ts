...
type RouteParams = {  };
type RouteId = '/(protected)/administration/calendar';
...
type ActionsExport = typeof import('../../../../../../../src/routes/(protected)/administration/calendar/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(protected)/administration/calendar/+page.server.js').load>>>>>>;
