...
type RouteParams = {  };
type RouteId = '/(protected)/administration/plans';
...
type LayoutRouteId = RouteId | "/(protected)/administration/plans" | "/(protected)/administration/plans/[id]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(protected)/administration/plans/+layout.server.js').load>>>>>>;
