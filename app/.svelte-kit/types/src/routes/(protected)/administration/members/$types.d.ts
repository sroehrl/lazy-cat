...
type RouteParams = {  };
type RouteId = '/(protected)/administration/members';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(protected)/administration/members/+page.server.js').load>>>>>>;
